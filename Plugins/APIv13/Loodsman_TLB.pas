...
// $Rev: 34747 $
// File generated on 22.04.2014 13:11:41 from Type Library described below.

// ************************************************************************  //
// Type Lib: Loodsman13.tlb (1)
...
// Cmdline:
//   "\\C-1177\c$\Program Files (x86)\Embarcadero\RAD Studio\8.0\bin\tlibimp.exe"  -P Loodsman13.tlb
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
// *********************************************************************//
  ILoodsmanApplication = interface(IDispatch)
    ...
    function ShowWindow(const ACaption: WideString; const AContext: IDBContext; 
                        const ACLSID: WideString; AFlags: Integer): IDBWindow; safecall;
    function OpenURL(const URLString: WideString): Integer; safecall;
...
// *********************************************************************//
  ILoodsmanApplicationDisp = dispinterface
    ...
    function OpenURL(const URLString: WideString): Integer; dispid 235;
...
// *********************************************************************//
  IApplicationMenu = interface(IDispatch)
    ...
    function Get_MenuBarCount: Integer; safecall;
    function GetMenuBar(AIndex: Integer): IMenuBar; safecall;
    function GetMenuBarByText(const AText: WideString): IMenuBar; safecall;
    ...
    property MenuBarCount: Integer read Get_MenuBarCount;
  end;
...
// *********************************************************************//
  IApplicationMenuDisp = dispinterface
    ['{9758DAA9-74D9-4A13-95EB-356F3FE66073}']
    property MenuBarCount: Integer readonly dispid 201;
    function GetMenuBar(AIndex: Integer): IMenuBar; dispid 202;
    function GetMenuBarByText(const AText: WideString): IMenuBar; dispid 203;
    function CreateMenuItem(const MenuItemID: WideString; const MenuCaption: WideString; 
                            MenuItemType: MenuItemTypes; const Description: WideString; 
...
{$ENDIF}
  ...
  public
    ...
    function ShowWindow(const ACaption: WideString; const AContext: IDBContext; 
                        const ACLSID: WideString; AFlags: Integer): IDBWindow;
    function OpenURL(const URLString: WideString): Integer;
    procedure AddActionHandler(const ActionHandler: IActionHandler; ActionCommand: Integer; 
...
function TLooApplication.OpenURL(const URLString: WideString): Integer;
begin
  Result := DefaultInterface.OpenURL(URLString);
end;
