...
function TCPDMData.Get_LockLevel: PDMLockLevels;
begin
    Result := DefaultInterface.LockLevel;
end;

function TCPDMData.Get_AccessLevel: PDMAccessLevels;
begin
...
function TCPDMDataProperties.Get_LockLevel: PDMLockLevels;
begin
    Result := DefaultInterface.LockLevel;
end;

function TCPDMDataProperties.Get_AccessLevel: PDMAccessLevels;
begin
    Result := DefaultInterface.AccessLevel;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TCPDMData, TCPDMObject, TCPDMDocument, TCPDMFile, 
    TCPDMCollection, TCView, TCAnnotation, TCLoodsmanUser, TCWFObject, 
    TCWFRoute, TCWFTask, TCTaskTerm, TCRTFText, TCPDMLink, 
    TCoWFMail, TObjectBuilder]);
end;
