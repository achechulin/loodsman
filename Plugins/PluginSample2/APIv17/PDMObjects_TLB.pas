...
// ************************************************************************  //
// Type Lib: C:\Program Files\ASCON\Loodsman\Client\PDMObjects.dll (1)
...
const
  ...
  IID_IPDMAbstractAttribute: TGUID = '{D3DE218A-2007-4B11-81D5-45EB65792C28}';
  IID_IPDMAttribute: TGUID = '{1FE7C795-8E19-4F1A-B499-65FC4AABE63B}';
  CLASS_CoPDMAttribute: TGUID = '{DD7F48FA-73BF-47F5-94B1-8C1DCD830680}';
  IID_IPDMMetaDataAttribute: TGUID = '{24DDB5AB-63E7-4944-AC2A-42DD030B9ACB}';
  CLASS_CoPDMMetaDataAttribute: TGUID = '{3E1C30F6-BF46-4F51-95FA-9040CCD6D0EE}';
  IID_IPDMQuantityAttribute: TGUID = '{BB5E3669-DBEA-4E9B-84B1-884205834511}';
  CLASS_CoPDMQuantityAttribute: TGUID = '{46203F33-A6B1-49D4-B905-64FA3008060B}';
  IID_IPDMObjectAttributeCollection: TGUID = '{6E4EBEB0-BC85-43FE-9AD5-0B0DB57901A6}';
  CLASS_CoPDMObjectAttributeCollection: TGUID = '{05ABCA83-72CE-44DA-97E0-7D4A623D1CD5}';
...
// Constants for enum TBPRights
type
  TBPRights = TOleEnum;
const
  TBP_UNKNOWN = $FFFFFFFF;
  TBP_NONE = $00000000;
  TBP_RUN = $00000001;
  TBP_EDIT = $00000002;
...
const
  ...
  WA_LINK = $00000002;
  WA_TYPE = $00000003;
  WA_TYPESLINK = $00000004;
  WA_KEYATTR = $00000005;
  WA_QUANTITY = $00000006;
...
// *********************************************************************//
  ...
  IPDMAbstractAttribute = interface;
  IPDMAbstractAttributeDisp = dispinterface;
  IPDMAttribute = interface;
  IPDMAttributeDisp = dispinterface;
  IPDMMetaDataAttribute = interface;
  IPDMMetaDataAttributeDisp = dispinterface;
  IPDMQuantityAttribute = interface;
  IPDMQuantityAttributeDisp = dispinterface;
  IPDMObjectAttributeCollection = interface;
  IPDMObjectAttributeCollectionDisp = dispinterface;
...
// *********************************************************************//
  ...
  CoPDMAttribute = IPDMAttribute;
  CoPDMMetaDataAttribute = IPDMMetaDataAttribute;
  CoPDMQuantityAttribute = IPDMMetaDataAttribute;
  CoPDMObjectAttributeCollection = IPDMObjectAttributeCollection;
...
// *********************************************************************//
  IPDMObject = interface(IProtectedPDMData)
    ...
    function Get_Attributes: IPDMObjectAttributeCollection; safecall;
    ...
    property Attributes: IPDMObjectAttributeCollection read Get_Attributes;
...
// *********************************************************************//
  IPDMObjectDisp = dispinterface
    ...
    property Attributes: IPDMObjectAttributeCollection readonly dispid 240;
    property ExistStatus: Integer readonly dispid 241;
    property LockLevel: PDMLockLevels readonly dispid 204;
    property AccessLevel: PDMAccessLevels readonly dispid 205;
    property ID: Integer readonly dispid 201;
    property Name: WideString readonly dispid 202;
...
// *********************************************************************//
  IView = interface(IDispatch)
    ...
    function Get_RevisionViewId: Integer; safecall;
    procedure Set_RevisionViewId(Value: Integer); safecall;
    property FileName: WideString read Get_FileName;
    property RevisionViewId: Integer read Get_RevisionViewId write Set_RevisionViewId;
  end;
...
// *********************************************************************//
  IViewDisp = dispinterface
    ...
    property RevisionViewId: Integer dispid 206;
  end;
...
// *********************************************************************//
  IAnnotationDisp = dispinterface
    ...
    property RevisionViewId: Integer dispid 208;
  end;
...
// *********************************************************************//
  IWFTask = interface(IWFObject)
    ...
    function Get_TBPTask: IWFTask; safecall;
    function Get_SignRoleID: Integer; safecall;
    function Get_SignRoleName: WideString; safecall;
    ...
    property TBPTask: IWFTask read Get_TBPTask;
    property SignRoleID: Integer read Get_SignRoleID;
    property SignRoleName: WideString read Get_SignRoleName;
...
// *********************************************************************//
  IWFTaskDisp = dispinterface
    ...
    property TBPTask: IWFTask readonly dispid 224;
    property SignRoleID: Integer readonly dispid 225;
    property SignRoleName: WideString readonly dispid 226;
    property Number: Integer readonly dispid 227;
    property WorkerReceived: Integer dispid 228;
    property ObjectType: WFObjectTypes readonly dispid 204;
    property ID: Integer readonly dispid 201;
    property Name: WideString readonly dispid 202;
    property ObjectCode: Integer readonly dispid 203;
...
// *********************************************************************//
  IObjectBuilder = interface(IDispatch)
    ...
    function ObjectFromDS(const Connection: IDispatch; ObjectCode: Integer; DS: OleVariant; 
                          ObjectID: Integer; const IDFieldName: WideString): IDispatch; safecall;
  end;
...
// *********************************************************************//
  IObjectBuilderDisp = dispinterface
    ...
    function ObjectFromDS(const Connection: IDispatch; ObjectCode: Integer; DS: OleVariant; 
                          ObjectID: Integer; const IDFieldName: WideString): IDispatch; dispid 205;
  end;
...
// *********************************************************************//
// Interface: IPDMAbstractAttribute
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D3DE218A-2007-4B11-81D5-45EB65792C28}
// *********************************************************************//
  IPDMAbstractAttribute = interface(IPDMData)
    ['{D3DE218A-2007-4B11-81D5-45EB65792C28}']
    function Get_SystemAttr: WordBool; safecall;
    function Get_AttrType: Integer; safecall;
    function Get_AttrUnit: DBEntityCom; safecall;
    procedure Set_AttrUnit(Value: DBEntityCom); safecall;
    function Get_AttrMeasure: DBEntityCom; safecall;
    procedure Set_AttrMeasure(Value: DBEntityCom); safecall;
    function Get_AttrValue: WideString; safecall;
    procedure Set_AttrValue(const Value: WideString); safecall;
    function Get_BlobValue: OleVariant; safecall;
    procedure Set_BlobValue(Value: OleVariant); safecall;
    function Get_WhoseAttr: Integer; safecall;
    function Get_Editable: WordBool; safecall;
    function Get_DefaultValue: WideString; safecall;
    function Get_Obligatory: WordBool; safecall;
    function Get_ValueList: WideString; safecall;
    function Get_OnlyListItems: WordBool; safecall;
    function Get_MeasuresData: OleVariant; safecall;
    function MeasureUnitsData(const AMeasure: WideString): OleVariant; safecall;
    function EditInDialog: WordBool; safecall;
    function Get_AttrOwner: IPDMData; safecall;
    function SaveToDB: WordBool; safecall;
    function Get_Changed: WordBool; safecall;
    property SystemAttr: WordBool read Get_SystemAttr;
    property AttrType: Integer read Get_AttrType;
    property AttrUnit: DBEntityCom read Get_AttrUnit write Set_AttrUnit;
    property AttrMeasure: DBEntityCom read Get_AttrMeasure write Set_AttrMeasure;
    property AttrValue: WideString read Get_AttrValue write Set_AttrValue;
    property BlobValue: OleVariant read Get_BlobValue write Set_BlobValue;
    property WhoseAttr: Integer read Get_WhoseAttr;
    property Editable: WordBool read Get_Editable;
    property DefaultValue: WideString read Get_DefaultValue;
    property Obligatory: WordBool read Get_Obligatory;
    property ValueList: WideString read Get_ValueList;
    property OnlyListItems: WordBool read Get_OnlyListItems;
    property MeasuresData: OleVariant read Get_MeasuresData;
    property AttrOwner: IPDMData read Get_AttrOwner;
    property Changed: WordBool read Get_Changed;
  end;

// *********************************************************************//
// DispIntf:  IPDMAbstractAttributeDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D3DE218A-2007-4B11-81D5-45EB65792C28}
// *********************************************************************//
  IPDMAbstractAttributeDisp = dispinterface
    ['{D3DE218A-2007-4B11-81D5-45EB65792C28}']
    property SystemAttr: WordBool readonly dispid 204;
    property AttrType: Integer readonly dispid 205;
    property AttrUnit: {??DBEntityCom}OleVariant dispid 206;
    property AttrMeasure: {??DBEntityCom}OleVariant dispid 207;
    property AttrValue: WideString dispid 208;
    property BlobValue: OleVariant dispid 209;
    property WhoseAttr: Integer readonly dispid 210;
    property Editable: WordBool readonly dispid 211;
    property DefaultValue: WideString readonly dispid 212;
    property Obligatory: WordBool readonly dispid 213;
    property ValueList: WideString readonly dispid 214;
    property OnlyListItems: WordBool readonly dispid 215;
    property MeasuresData: OleVariant readonly dispid 216;
    function MeasureUnitsData(const AMeasure: WideString): OleVariant; dispid 217;
    function EditInDialog: WordBool; dispid 218;
    property AttrOwner: IPDMData readonly dispid 219;
    function SaveToDB: WordBool; dispid 220;
    property Changed: WordBool readonly dispid 222;
    property ID: Integer readonly dispid 201;
    property Name: WideString readonly dispid 202;
    property ObjectCode: Integer readonly dispid 203;
  end;
...
// *********************************************************************//
// Interface: IPDMAttribute
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1FE7C795-8E19-4F1A-B499-65FC4AABE63B}
// *********************************************************************//
  IPDMAttribute = interface(IPDMAbstractAttribute)
    ['{1FE7C795-8E19-4F1A-B499-65FC4AABE63B}']
    function Get_IsDeleted: WordBool; safecall;
    procedure Set_IsDeleted(Value: WordBool); safecall;
    property IsDeleted: WordBool read Get_IsDeleted write Set_IsDeleted;
  end;

// *********************************************************************//
// DispIntf:  IPDMAttributeDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1FE7C795-8E19-4F1A-B499-65FC4AABE63B}
// *********************************************************************//
  IPDMAttributeDisp = dispinterface
    ['{1FE7C795-8E19-4F1A-B499-65FC4AABE63B}']
    property IsDeleted: WordBool dispid 241;
    property SystemAttr: WordBool readonly dispid 204;
    property AttrType: Integer readonly dispid 205;
    property AttrUnit: {??DBEntityCom}OleVariant dispid 206;
    property AttrMeasure: {??DBEntityCom}OleVariant dispid 207;
...
// *********************************************************************//
// Interface: IPDMMetaDataAttribute
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {24DDB5AB-63E7-4944-AC2A-42DD030B9ACB}
// *********************************************************************//
  IPDMMetaDataAttribute = interface(IPDMAbstractAttribute)
    ['{24DDB5AB-63E7-4944-AC2A-42DD030B9ACB}']
    function Get_IsTypeAttr: WordBool; safecall;
    function Get_IsKeyAttr: WordBool; safecall;
    function CreateObjectAttr: IPDMAttribute; safecall;
    property IsTypeAttr: WordBool read Get_IsTypeAttr;
    property IsKeyAttr: WordBool read Get_IsKeyAttr;
  end;

// *********************************************************************//
// DispIntf:  IPDMMetaDataAttributeDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {24DDB5AB-63E7-4944-AC2A-42DD030B9ACB}
// *********************************************************************//
  IPDMMetaDataAttributeDisp = dispinterface
    ['{24DDB5AB-63E7-4944-AC2A-42DD030B9ACB}']
    property IsTypeAttr: WordBool readonly dispid 241;
    property IsKeyAttr: WordBool readonly dispid 242;
    function CreateObjectAttr: IPDMAttribute; dispid 243;
    property SystemAttr: WordBool readonly dispid 204;
    property AttrType: Integer readonly dispid 205;
    property AttrUnit: {??DBEntityCom}OleVariant dispid 206;
    property AttrMeasure: {??DBEntityCom}OleVariant dispid 207;
...
// *********************************************************************//
// Interface: IPDMQuantityAttribute
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BB5E3669-DBEA-4E9B-84B1-884205834511}
// *********************************************************************//
  IPDMQuantityAttribute = interface(IPDMAbstractAttribute)
    ['{BB5E3669-DBEA-4E9B-84B1-884205834511}']
    function Get_MinQuantity: Double; safecall;
...
// *********************************************************************//
// DispIntf:  IPDMQuantityAttributeDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BB5E3669-DBEA-4E9B-84B1-884205834511}
// *********************************************************************//
  IPDMQuantityAttributeDisp = dispinterface
    ['{BB5E3669-DBEA-4E9B-84B1-884205834511}']
    property MinQuantity: Double dispid 241;
    property MaxQuantity: Double dispid 242;
    property SystemAttr: WordBool readonly dispid 204;
    property AttrType: Integer readonly dispid 205;
    property AttrUnit: {??DBEntityCom}OleVariant dispid 206;
    property AttrMeasure: {??DBEntityCom}OleVariant dispid 207;
...
// *********************************************************************//
// Interface: IPDMObjectAttributeCollection
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6E4EBEB0-BC85-43FE-9AD5-0B0DB57901A6}
// *********************************************************************//
  IPDMObjectAttributeCollection = interface(IDispatch)
    ['{6E4EBEB0-BC85-43FE-9AD5-0B0DB57901A6}']
    function Get_Items(Index: Integer): IPDMAbstractAttribute; safecall;
    function Get_Count: Integer; safecall;
    function ItemByName(const ItemName: WideString; var WhoseAttr: Integer): IPDMAbstractAttribute; safecall;
    function ItemByID(ItemID: Integer; var WhoseAttr: Integer): IPDMAbstractAttribute; safecall;
    procedure Delete(Index: Integer); safecall;
    function SaveToDB: WordBool; safecall;
    function Clone: IPDMObjectAttributeCollection; safecall;
    function Get_Changed: WordBool; safecall;
    property Items[Index: Integer]: IPDMAbstractAttribute read Get_Items;
    property Count: Integer read Get_Count;
    property Changed: WordBool read Get_Changed;
  end;

// *********************************************************************//
// DispIntf:  IPDMObjectAttributeCollectionDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6E4EBEB0-BC85-43FE-9AD5-0B0DB57901A6}
// *********************************************************************//
  IPDMObjectAttributeCollectionDisp = dispinterface
    ['{6E4EBEB0-BC85-43FE-9AD5-0B0DB57901A6}']
    property Items[Index: Integer]: IPDMAbstractAttribute readonly dispid 201;
    property Count: Integer readonly dispid 202;
    function ItemByName(const ItemName: WideString; var WhoseAttr: Integer): IPDMAbstractAttribute; dispid 203;
    function ItemByID(ItemID: Integer; var WhoseAttr: Integer): IPDMAbstractAttribute; dispid 204;
    procedure Delete(Index: Integer); dispid 205;
    function SaveToDB: WordBool; dispid 206;
    function Clone: IPDMObjectAttributeCollection; dispid 207;
    property Changed: WordBool readonly dispid 208;
  end;
