...
// ************************************************************************  //
// Type Lib: C:\Program Files\Common Files\ASCON Shared\BOSimple.dll (1)
...
// *********************************************************************//
  IBOObjectDisp = dispinterface
    ...
    property Parent: IDispatch dispid 301;
    property XML: WideString readonly dispid 1610743808;
  end;
...
// *********************************************************************//
  IBOAttributeCollectionDisp = dispinterface
    ...
    procedure DeleteAttribute(const AAttribute: IBOAttribute); dispid 302;
    function AttributeExists(const aName: WideString): WordBool; dispid 303;
    property Parent: IDispatch dispid 301;
    property Count: Integer readonly dispid 1;
    property XML: WideString readonly dispid 4;
    procedure Clear; dispid 200;
...
// *********************************************************************//
  IBORequestDisp = dispinterface
    ...
    property Parent: IDispatch dispid 201;
  end;
...
// *********************************************************************//
  IBOResponseDisp = dispinterface
    ...
    property Objects: IBOObjectCollection readonly dispid 201;
    property Parent: IDispatch dispid 202;
  end;
...
// *********************************************************************//
  IBOSimpleProviderDisp = dispinterface
    ...
    property NewQuery: IBOQuery readonly dispid 201;
    procedure ExecuteQuery(const AQuery: IBOQuery; out AErrorCode: Integer; 
                           out AErrorMessage: WideString); dispid 202;
    function Select2(Modal: WordBool; ClientWindow: Integer; const InLocation: WideString; 
                     out OutLocation: WideString): WordBool; dispid 204;
    procedure GetObjectInfo2(const Location: WideString; out ClassID: WideString; 
                             out ObjectID: WideString); dispid 205;
    function GetObject2(const ClassID: WideString; const ObjectID: WideString; Options: Integer): IBOObject; dispid 206;
    function GetObjects2(const ClassID: WideString; Options: Integer): IBOObjectCollection; dispid 207;
  end;
...
// *********************************************************************//
// DispIntf:  IBOQueryDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1F391262-7322-4806-8792-DFA83E15FCE9}
// *********************************************************************//
  IBOQueryDisp = dispinterface
    ['{1F391262-7322-4806-8792-DFA83E15FCE9}']
    property Request: IBORequest readonly dispid 201;
    property Response: IBOResponse readonly dispid 202;
  end;
